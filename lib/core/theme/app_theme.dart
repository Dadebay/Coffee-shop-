    ...
    return ThemeData(
      ...
      navigationRailTheme: NavigationRailThemeData(
        ...
        unselectedLabelTextStyle:
            TextStyle(fontFamily: 'Gilroy', color: txtGrey),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: TextStyle(
            fontFamily: 'Gilroy', color: txtGrey, fontWeight: FontWeight.w500),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          textStyle: const TextStyle(
              fontFamily: 'Gilroy', fontWeight: FontWeight.w600, fontSize: 15),
        ),
      ),
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: TextStyle(
            fontFamily: 'Gilroy', color: txtWh, fontWeight: FontWeight.w500),
        side: BorderSide(color: bgBord),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
      ),
      textTheme: TextTheme(
        displayLarge: TextStyle(
            fontFamily: 'Gilroy', fontWeight: FontWeight.w700, color: txtWh),
        ...
        titleLarge: TextStyle(
            fontFamily: 'Gilroy', fontWeight: FontWeight.w600, color: txtWh),
        titleMedium: TextStyle(
            fontFamily: 'Gilroy', fontWeight: FontWeight.w600, color: txtWh),
        titleSmall: TextStyle(
            fontFamily: 'Gilroy', fontWeight: FontWeight.w600, color: txtWh),
        bodyLarge: TextStyle(
            fontFamily: 'Gilroy', fontWeight: FontWeight.w400, color: txtWh),
        bodyMedium: TextStyle(
            fontFamily: 'Gilroy', fontWeight: FontWeight.w400, color: txtWh),
        bodySmall: TextStyle(
            fontFamily: 'Gilroy', fontWeight: FontWeight.w400, color: txtGrey),
        labelLarge: TextStyle(
            fontFamily: 'Gilroy', fontWeight: FontWeight.w600, color: txtWh),
        labelMedium: TextStyle(
            fontFamily: 'Gilroy', fontWeight: FontWeight.w500, color: txtWh),
        labelSmall: TextStyle(
            fontFamily: 'Gilroy', fontWeight: FontWeight.w500, color: txtGrey),
      ),
    );
  }
}
