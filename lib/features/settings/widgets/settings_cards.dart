...
// ── Action log nav card ───────────────────────────────────────────────────────
class ActionLogNavCard extends StatelessWidget {
  const ActionLogNavCard({super.key});
...
class AddUserBtn extends StatelessWidget {
  ...
  const AddUserBtn({super.key, required this.onTap});
